...
mcf ${date1}_${date2}.diff ${date1}_${date2}.cc_ad - ${date1}_${date2}.diff.unw $mli1_width 0 0 0 - - 1 1 512 180 2046 1

# Low pass filtering
create_diff_par 20160202_20160214.off - diff_par 0 0
fspf ${date1}_${date2}.diff.unw pmodel $mli1_width 2 200 4 -
dis2rmg ${date1}_${date2}.diff.unw pmodel ${mli1_width} ${mli1_width}

sub_phase ${date1}_${date2}.diff pmodel diff_par ${date1}_${date2}.diff_pmodel 1 0
mcf ${date1}_${date2}.diff_pmodel ${date1}_${date2}.cc_ad - ${date1}_${date2}.diff_pmodel.unw $mli1_width 0 0 0 - - 1 1 512 180 2046 1
dis2rmg ${date1}_${date2}.diff_pmodel.unw ${date1}_${date2}.diff.unw ${mli1_width} ${mli1_width}

# atmosphere modeling: option 1
atm_mod2 ${date1}_${date2}.diff_pmodel.unw 20160202.hgt 20160202.mli.par atmphase1 - - - 3 - - rpt
dis2rmg ${date1}_${date2}.diff_pmodel.unw atmphase1 ${mli1_width} ${mli1_width}

# atmosphere modeling: option 2 
atm_mod_2d ${date1}_${date2}.diff_pmodel.unw 20160202.hgt ${date1}_${date2}.cc_ad diff_par - 0 a0 a1 sigma s0 s1 - - - - - - 0.01
atm_sim_2d diff_par 20160202.hgt a0 a1 atmphase2
dis2rmg ${date1}_${date2}.diff_pmodel.unw atmphase2 ${mli1_width} ${mli1_width}

sub_phase 20160202_20160214.diff_pmodel atmphase2 diff_par 20160202_20160214.diff_pmodel_atm 1 0
mcf 20160202_20160214.diff_pmodel_atm ${date1}_${date2}.cc_ad - 20160202_20160214.diff_pmodel_atm.unw $mli1_width 0 0 0 - - 1 1 512 180 2046 1
dis2rmg ${date1}_${date2}.diff_pmodel_atm.unw 20160202_20160214.diff.unw ${mli1_width} ${mli1_width}

# displacement
dispmap ${date1}_${date2}.diff_pmodel_atm.unw ${date1}.hgt ${date1}.slc.par ${date1}_${date2}.off ${date1}_${date2}.disp 0
